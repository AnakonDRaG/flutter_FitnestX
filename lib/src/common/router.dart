...
import 'package:FitnestX/src/screens/dashboard/Notification.dart';
import 'package:FitnestX/src/screens/dashboard/index.dart';
...
class AppRouter {
  final String initialLocation = '/dashboard';
  ...
  GoRouter get getRouter => GoRouter(
        ...
        routes: <GoRoute>[
          ...
          GoRoute(
            ...
            builder: (BuildContext context, GoRouterState state) =>
                const DashboardNotificationScreen(),
          ),
        ],
      );
}
